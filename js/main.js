...
async function GenerateProductsListScroller() {
  ...
  data.forEach((product) => {
    ...
    const item = scrollerTemplateItem.cloneNode(true);
    ...
    item.querySelector(".products__list__scroller__title").textContent =
      product.title;
    item.querySelector(".products__list__scroller__price").textContent =
      product.price;
...
async function fetchProductList() {
  const data = await fetchProducts();
  data.forEach((product) => {
    const item = listTemplateItem.cloneNode(true);

    item.querySelector(".product__list-img").src = product.image;
    item.querySelector(".product__list-img").alt = product.title;
    item.querySelector(".product__list__title").textContent = product.title;
    item.querySelector(".product__list__price").textContent = product.price;
